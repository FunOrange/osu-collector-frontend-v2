        ...
        <DialogContent className="max-w-5xl" onPointerDownOutside={() => setPreviewOpened(false)}>
          ...
          <DialogHeader>
            <DialogTitle className="text-slate-500">
              Import mappool collections (preview)
            </DialogTitle>
          </DialogHeader>
          <DialogDescription style={{ pointerEvents: overlayVisible ? "none" : "all" }}>
            <div
              className="grid"
              style={{ height: "calc(100dvh - 180px)", gridTemplateColumns: "3fr 7fr" }}
            >
              <div>
              ...
              <div className="flex flex-col" style={{ height: "inherit" }}>
                <div className="mb-3 text-xl text-white">
                  ...
                  <span className="text-slate-500">
                    {previewCollections.length} collection{s(previewCollections.length)} to be
                    imported
                  </span>
                </div>
                {(() => {
