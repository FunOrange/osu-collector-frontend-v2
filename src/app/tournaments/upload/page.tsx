...
} from "@/app/tournaments/upload/mappoolTemplate";
...
export default function TournamentsPage({ tournament = null }: TournamentsPageProps) {
  ...
  const [mappoolText, setMappoolText] = useState(
    creating ? mappoolTemplate : getMappoolTextFromTournament(tournament)
  );
          ...
          <div className="p-4 rounded bg-slate-700 md:p-7">
              ...
              <div>
                <Label htmlFor="banner-url">
                  ...
                  <span className="text-sm text-slate-500">
                    Optional, only https://i.ppy.sh allowed
                  </span>
                </Label>
                <Input
                  type="text"
                  id="banner-url"
                  placeholder="https://i.ppy.sh/..."
                  {...form.inputProps("banner")}
                />
                <div className="text-sm text-slate-500">
                  You can get the banner URL by going to the tournament forum page, right clicking
                  the banner image, and clicking &quot;Copy image address&quot;
                </div>
              </div>
              <div>
            ...
            <div>
              ...
              <div className="text-sm text-slate-500">
                ...
                tournament. To reset back to the default template,{" "}
                <Dialog>
                  <DialogTrigger className="text-blue-400 underline">click here.</DialogTrigger>
                  <DialogContent>
                    <div className="text-sm text-slate-500">
                      Are you sure you want to reset back to the default template? All data
                      previously entered in the mappool textbox will be lost.
                    </div>
                    <DialogClose asChild>
                      <Button
                        variant="destructive"
